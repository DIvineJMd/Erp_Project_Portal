  ...
  return (
    <div className="min-h-screen bg-backG">
      ...
      <div className="grid min-h-screen grid-cols-1 md:grid-cols-[0.4fr,auto_1fr] place-content-stretchf gap-4 overflow-hidden px-4 md:px-20 py-10">
        ...
        <div className=" rounded w-full md:w-[200%] bg-white px-4  relative max-h-screen overflow-y-auto">
          ...
          {clicked === 1 && <Sent numberOfProposals={5}></Sent>}
          {clicked === 2 && (
            <div className="py-5">This is visible when clicked is 2</div>
          )}
        </div>
      </div>
    </div>
